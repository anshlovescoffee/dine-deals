...
from db_logic import get_db_connection, like_promo_code
import uuid

like_blueprint = Blueprint('like_blueprint', __name__)  # Define the Blueprint
...
def like():
    ...
    like_promo_code(db, user_id, promocode_id)
